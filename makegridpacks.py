...
import abc, contextlib, collections, csv, filecmp, glob, os, random, re, shutil, stat, subprocess, sys, urllib
...
class POWHEGJHUGenMCSample(MCSampleBase):
  ...
  @property
  def hasfilter(self): return "filter" in self.JHUGencard.lower()
  @property
  def tmptarball(self):
